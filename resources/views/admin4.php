...
<body>
    ...
    <div class="form">
        ...
        <div class="subtitle">Add student or docter </div>
        ...
        <div class="input-container ic2">
          <input id="lastname" class="input" type="text" placeholder=" Password" />
          
          
        </div>

        <div class="input-container ic3">
          <input id="email" class="input" type="text" placeholder=" Academic number " />
